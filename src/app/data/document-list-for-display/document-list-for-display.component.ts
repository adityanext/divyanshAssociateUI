...
@Component({
  selector: 'app-document-list-for-display',
  templateUrl: './document-list-for-display.component.html',
  styleUrls: ['./document-list-for-display.component.scss']
})
export class DocumentListForDisplayComponent implements OnInit {

  constructor(private customerDataServices: CustomerDataService ){}  

  displayedColumns: string[] = ["document"];
